...
var process_doc = function (filename, question) { return __awaiter(void 0, void 0, void 0, function () {
    var model, loader, doc, vectorStore, vectorStoreRetriever, chain;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                model = new langchain_1.OpenAI({});
                loader = new pdf_1.PDFLoader("/Users/javie/3D Objects/Nueva carpeta (2)/J.C-MOVIL/mobil-2-main/backend/upload".concat(filename), {
                    splitPages: false
                });
                return [4 /*yield*/, loader.load()];
            case 1:
                doc = _a.sent();
                return [4 /*yield*/, memory_1.MemoryVectorStore.fromDocuments(doc, new openai_1.OpenAIEmbeddings())];
            case 2:
                vectorStore = _a.sent();
